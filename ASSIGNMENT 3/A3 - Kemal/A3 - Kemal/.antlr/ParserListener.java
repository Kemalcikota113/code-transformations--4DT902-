// Generated from c:/Users/armin/Desktop/Code transformations/A2/Parser.g4 by ANTLR 4.13.1
...
public interface ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ifffStmt}
	 * labeled alternative in {@link ParserParser#stmt}.
	 * @param ctx the parse tree
	 */
	void enterIfffStmt(ParserParser.IfffStmtContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ifffStmt}
	 * labeled alternative in {@link ParserParser#stmt}.
	 * @param ctx the parse tree
	 */
	void exitIfffStmt(ParserParser.IfffStmtContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterTypeExpr(ParserParser.TypeExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TypeExpr}
	 * labeled alternative in {@link ParserParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitTypeExpr(ParserParser.TypeExprContext ctx);
	/**
