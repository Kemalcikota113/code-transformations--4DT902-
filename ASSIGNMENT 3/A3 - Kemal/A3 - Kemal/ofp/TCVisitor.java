...
public class TCVisitor extends ParserBaseVisitor<OFPType> {
    ...
    public OFPType visitArrayVar(ParserParser.ArrayVarContext ctx) {
        ...
        OFPType varType = varSymbol.getType();
        if (!varType.equals(OFPType.intArrType) && !varType.equals(OFPType.floatArrType) && !varType.equals(OFPType.charArrType) && !varType.equals(OFPType.stringType)) {
        ...
        if (varType.equals(OFPType.charArrType) || varType.equals(OFPType.stringType)) {
            return OFPType.charType;
        }
